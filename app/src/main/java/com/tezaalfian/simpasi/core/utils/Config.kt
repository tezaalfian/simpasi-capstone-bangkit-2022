...
class Config {
    ...
    companion object {
        private const val DEFAULT_LOCAL_MODEL_PATH = "simpasi.tflite"
        private const val DEFAULT_MOVIE_LIST_PATH = "sorted_menu_vocab.json"
        private const val REMOTE_MODEL_NAME = "simpasi"
